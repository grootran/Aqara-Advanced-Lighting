...
EFFECT_PRESETS: Final[dict[str, dict[str, Any]]] = {
    ...
    # T1M audio-reactive presets
    PRESET_T1M_LITTLE_FLUFFY_CLOUDS: {
        "name": "Little Fluffy Clouds",
        "icon": "mdi:cloud-outline",
        "effect": EffectType.FADING,
        "colors": [[180, 140, 230], [80, 100, 220], [140, 160, 255], [235, 230, 255]],
        "speed": 15,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
        "audio_detection_mode": AUDIO_DETECTION_MODE_SPECTRAL_FLUX,
        "audio_sensitivity": 40,
        "audio_silence_behavior": AUDIO_SILENCE_DECAY_MID,
        "audio_speed_mode": AUDIO_EFFECT_MODE_INTENSITY_BREATHING,
        "audio_speed_min": 5,
        "audio_speed_max": 25,
        "audio_speed_curve": AUDIO_RESPONSE_CURVE_LOGARITHMIC,
        "audio_brightness_mode": AUDIO_EFFECT_MODE_INTENSITY_BREATHING,
        "audio_brightness_min": 20,
        "audio_brightness_max": 100,
        "audio_brightness_curve": AUDIO_RESPONSE_CURVE_LOGARITHMIC,
    },
    PRESET_T1M_WAREHOUSE: {
        "name": "Warehouse",
        "icon": "mdi:warehouse",
        "effect": EffectType.HOPPING,
        "colors": [[255, 0, 0], [0, 0, 255], [255, 220, 0], [0, 200, 0]],
        "speed": 75,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
        ...
        "audio_speed_mode": AUDIO_EFFECT_MODE_ON_ONSET,
        "audio_speed_min": 40,
        "audio_speed_max": 100,
        "audio_speed_curve": AUDIO_RESPONSE_CURVE_LINEAR,
        "audio_brightness_mode": AUDIO_EFFECT_MODE_INTENSITY_BREATHING,
        "audio_brightness_min": 50,
        "audio_brightness_max": 100,
        "audio_brightness_curve": AUDIO_RESPONSE_CURVE_LINEAR,
    },
    PRESET_T1M_TANGERINE_DREAM: {
        "name": "Tangerine Dream",
        "icon": "mdi:equalizer",
        "effect": EffectType.FLOW1,
        "colors": [[255, 100, 0], [200, 50, 10], [255, 175, 20], [160, 35, 0]],
        "speed": 35,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
        "audio_detection_mode": AUDIO_DETECTION_MODE_SPECTRAL_FLUX,
        ...
        "audio_speed_mode": AUDIO_EFFECT_MODE_CONTINUOUS,
        "audio_speed_min": 10,
        "audio_speed_max": 50,
        "audio_speed_curve": AUDIO_RESPONSE_CURVE_LOGARITHMIC,
    ...
    PRESET_T1M_RIDE_THE_LIGHTNING: {
        ...
        "effect": EffectType.ROLLING,
        "colors": [[0, 60, 255], [0, 190, 255], [150, 195, 255], [235, 245, 255]],
        "speed": 65,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
        ...
        "audio_speed_min": 30,
        "audio_speed_max": 100,
        "audio_speed_curve": AUDIO_RESPONSE_CURVE_EXPONENTIAL,
        "audio_brightness_mode": AUDIO_EFFECT_MODE_ONSET_FLASH,
        "audio_brightness_min": 40,
        "audio_brightness_max": 100,
        "audio_brightness_curve": AUDIO_RESPONSE_CURVE_EXPONENTIAL,
    },
    ...
    # T1 Strip audio-reactive presets
    PRESET_T1_STRIP_THUNDERSTRUCK: {
        "name": "Thunderstruck",
        "icon": "mdi:lightning-bolt",
        "effect": EffectType.DASH,
        "colors": [[0, 80, 255], [0, 200, 255], [180, 220, 255], [255, 255, 255]],
        "speed": 80,
        "brightness": 255,
        "device_types": [MODEL_T1_STRIP],
        "audio_detection_mode": AUDIO_DETECTION_MODE_COMPLEX_DOMAIN,
    ...
    PRESET_T1_STRIP_LUCY_IN_THE_SKY: {
        ...
        "effect": EffectType.RAINBOW2,
        "colors": [
            [255, 0, 180], [255, 130, 0], [0, 255, 100],
            [100, 0, 255], [0, 200, 255], [255, 230, 0],
        ],
        "speed": 45,
        "brightness": 255,
        "device_types": [MODEL_T1_STRIP],
    ...
    PRESET_T1_STRIP_RUNNING_UP_THAT_HILL: {
        ...
        "icon": "mdi:run",
        "effect": EffectType.CHASING,
        "colors": [[220, 0, 120], [130, 0, 220], [50, 100, 255], [200, 50, 200]],
        "speed": 55,
        "brightness": 255,
        "device_types": [MODEL_T1_STRIP],
        "audio_detection_mode": AUDIO_DETECTION_MODE_BASS_ENERGY,
    ...
    PRESET_T1_STRIP_NEON: {
        ...
        "effect": EffectType.BREATHING,
        "colors": [[0, 220, 200], [0, 255, 120], [0, 180, 220], [50, 255, 180]],
        "speed": 18,
        "brightness": 255,
        "device_types": [MODEL_T1_STRIP],
        "audio_detection_mode": AUDIO_DETECTION_MODE_SPECTRAL_FLUX,
