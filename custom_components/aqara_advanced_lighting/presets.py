...
EFFECT_PRESETS: Final[dict[str, dict[str, Any]]] = {
    ...
    PRESET_T1M_LITTLE_FLUFFY_CLOUDS: {
        ...
        "effect": EffectType.FADING,
        "colors": [[180, 140, 230], [80, 100, 220], [140, 160, 255], [235, 230, 255], [130, 0, 255]],
        "speed": 15,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
    ...
    PRESET_T1M_WAREHOUSE: {
        ...
        "icon": "mdi:warehouse",
        "effect": EffectType.HOPPING,
        "colors": [[255, 0, 0], [0, 0, 255], [255, 220, 0], [0, 200, 0], [255, 0, 250]],
        "speed": 75,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
    ...
    PRESET_T1M_TANGERINE_DREAM: {
        ...
        "icon": "mdi:equalizer",
        "effect": EffectType.FLOW1,
        "colors": [[255, 100, 0], [200, 50, 10], [255, 175, 20], [160, 35, 0], [255, 225, 30]],
        "speed": 35,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
        "audio_detection_mode": AUDIO_DETECTION_MODE_SPECTRAL_FLUX,
    ...
    PRESET_T1M_RIDE_THE_LIGHTNING: {
        ...
        "effect": EffectType.ROLLING,
        "colors": [[0, 60, 255], [0, 190, 255], [150, 195, 255], [235, 245, 255], [150, 195, 255], [0, 190, 255]],
        "speed": 65,
        "brightness": 255,
        "device_types": [MODEL_T1M_20_SEGMENT, MODEL_T1M_26_SEGMENT],
