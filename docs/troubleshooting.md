...
- **T1M and T1 Strip RGB transition speed** -- The T1M Ceiling Light and T1 LED Strip do not support smooth RGB color hardware based transitions over long periods. When used in dynamic scenes, color changes may appear more abrupt compared to bulbs like the T2 RGB or other lights that support long transitions natively.
